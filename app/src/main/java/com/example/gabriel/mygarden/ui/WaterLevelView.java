...
public class WaterLevelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        int colorPrimary = ContextCompat.getColor(mContext, R.color.colorDarkBlue);
        int colorPrimaryLight = ContextCompat.getColor(mContext, R.color.colorLightBlue);
